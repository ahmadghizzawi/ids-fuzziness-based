...
def load_data(dataset, test_dataset):
    ''' Loads the dataset
        ...
        :param test_dataset: the path to the dataset (here KDD)
        '''
    ...
    X_train, X_val, y_train, y_val = train_test_split(train_set_tuple[0], train_set_tuple[1], test_size=0.90, stratify=train_set_tuple[1])
    ...
    test_set_x, test_set_y = test_set_tuple
    valid_set_x, valid_set_y = val_set_tuple
...
if __name__ == '__main__':
    load_data('KDDTrain+.csv', 'KDDTest+.csv')
